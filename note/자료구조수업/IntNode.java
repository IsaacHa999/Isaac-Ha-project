 ...
 * IntNode.
 **/
 public void addNodeAfter(int item)     ///node1(10, null) node1.addNodeAfter(20) --> node1(10, node2주소), node2(20, nod1의 link 그대로 가져온다. )
 {
 link = new IntNode(item, link);        //다음 노드를 생성과 동시에 link에 포인터를 저장한다.!
 }  
 ...
 * Indicates that there is insufficient memory for the new list.
 **/
 public static IntNode[ ] listPart(IntNode start, IntNode end)      ///부분카피!!
 {
 IntNode copyHead;
 IntNode copyTail;
 IntNode cursor;
